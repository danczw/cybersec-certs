...
#table(
  ...
  table.header(
    ...
    text(fill: white, weight: "bold")[Mnemonic (top)],
    text(fill: white, weight: "bold")[Mnemonic (bottom)],
  ),
...
+ *Frame info* (Layer 1) — physical bytes on wire
+ *Ethernet II* (Layer 2) — source/destination MAC addresses
+ *Internet Protocol* (Layer 3) — source/destination IP addresses (e.g., 72.14.247.19 → googlemail.l.google.com)
+ *TCP* (Layer 4) — source/destination port numbers (destination port 443)
+ *SSL* (Layers 5/6/7) — session management, encryption/decryption, application data (Google Mail)
